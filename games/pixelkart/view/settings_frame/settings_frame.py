...
class settings(Frame):
    ...
    def __init__(self, parent, controler):
        ...
        self.player_selection_1 = Frame(self.players_frame, bg="lightblue")
        self.player_selection_2 = Frame(self.players_frame, bg="lightblue")
        ...
        # -------------------------
        self.circuit_frame = Frame(self, bg="lightgreen")
